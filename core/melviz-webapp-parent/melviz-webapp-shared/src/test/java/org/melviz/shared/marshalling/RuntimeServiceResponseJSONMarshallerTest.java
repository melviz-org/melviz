...
import org.melviz.shared.model.GlobalSettings;
...
public class RuntimeServiceResponseJSONMarshallerTest {
    ...
    public void toJsonTest() {
        ...
        RuntimeModel model = new RuntimeModel(new NavTreeBuilder().item("TestId", "TestItem", "Item Description", false).build(),
                                              ...
                                              new GlobalSettings());
        RuntimeServiceResponse response = new RuntimeServiceResponse(MelvizRuntimeMode.STATIC,
                                                                     Optional.of(model),
    ...
    public void fromJsonTest() {
        ...
        assertEquals(MelvizRuntimeMode.STATIC, response.getMode());
