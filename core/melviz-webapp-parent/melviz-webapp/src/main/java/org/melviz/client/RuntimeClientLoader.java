...
import org.melviz.client.parser.RuntimeModelClientParserFactory;
import org.melviz.client.plugins.RuntimePerspectivePluginManager;
...
import org.melviz.client.setup.RuntimeClientMode;
import org.melviz.client.setup.RuntimeClientSetup;
import org.melviz.dataset.events.DataSetDefRemovedEvent;
import org.melviz.displayer.client.RendererManager;
import org.melviz.patternfly.busyindicator.BusyIndicator;
import org.melviz.renderer.client.DefaultRenderer;
import org.melviz.shared.event.UpdatedGlobalSettingsEvent;
import org.melviz.shared.event.UpdatedRuntimeModelEvent;
...
public class RuntimeClientLoader {
    ...
    private RuntimeServiceResponse buildEditorResponse() {
        return new RuntimeServiceResponse(MelvizRuntimeMode.STATIC,
    ...
    private RuntimeServiceResponse buildClientResponse(RuntimeModel clientModel) {
        var clientMode = MelvizRuntimeMode.SINGLE_IMPORT;
        var list = new ArrayList<String>();
        if (setup.getDashboards() != null && setup.getDashboards().length > 1) {
            clientMode = MelvizRuntimeMode.MULTIPLE_IMPORT;
