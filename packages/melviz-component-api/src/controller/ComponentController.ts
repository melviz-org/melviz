...
/*
 * Controls component lifecycle and allows component communicate with Melviz
 */
export interface ComponentController {
  ...
  /*
   * Sets the method to be called when melviz sends a dataset update after a filter or when using pooling.
  ...
  /*
   * Used to send a filter request to Melviz
   */
