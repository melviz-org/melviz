 ...
 */
package org.melviz.shared.marshalling;
...
import org.melviz.json.JsonType;
...
public class LayoutTemplateJSONMarshaller {
    ...
    static final String DISPLAYER_DRAG_TYPE = "org.melviz.client.editor.DisplayerDragComponent";
    ...
    static final String SCREEN_DRAG_TYPE = "org.melviz.client.navigation.widget.ScreenLayoutDragComponent";
    ...
    static final String PANEL_DRAG_TYPE =
            "org.melviz.client.navigation.widget.PanelLayoutDragComponent";
    ...
    static {
        ...
        TYPES_DRAG.put("External", "org.melviz.client.editor.external.ExternalDragComponent");

        TYPES_DRAG.put("TABS", "org.melviz.client.navigation.layout.editor.NavTabListDragComponent");
        TYPES_DRAG.put("CAROUSEL", "org.melviz.client.navigation.layout.editor.NavCarouselDragComponent");
        TYPES_DRAG.put("TILES", "org.melviz.client.navigation.layout.editor.NavTilesDragComponent");
        TYPES_DRAG.put("TREE", "org.melviz.client.navigation.layout.editor.NavTreeDragComponent");
        TYPES_DRAG.put("MENU", "org.melviz.client.navigation.layout.editor.NavMenuBarDragComponent");
