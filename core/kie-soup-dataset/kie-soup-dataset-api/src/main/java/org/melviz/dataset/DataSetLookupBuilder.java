...
public interface DataSetLookupBuilder<T> {
     ...
     * @see org.melviz.dataset.group.GroupStrategy
     ...
     * @see org.melviz.dataset.group.DateIntervalType
     * @return The DataSetLookupBuilder instance that is being used to configure a DataSetLookup request.
     */
     ...
     * @see org.melviz.dataset.filter.ColumnFilter
     * @see org.melviz.dataset.filter.FilterFactory
     ...
     * @see org.melviz.dataset.sort.SortOrder
     * @return The DataSetLookupBuilder instance that is being used to configure a DataSetLookup request.
     */
