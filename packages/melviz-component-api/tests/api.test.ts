...
import { MelvizComponentController } from "../src/controller/MelvizComponentController";

const controller = new ComponentApi().getComponentController() as MelvizComponentController;
